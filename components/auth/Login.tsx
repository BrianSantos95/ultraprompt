...
const Login: React.FC = () => {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center min-h-[60vh] text-zinc-100 p-4">
            <div className="w-full max-w-lg bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 space-y-6 animate-in zoom-in-95 duration-300">
